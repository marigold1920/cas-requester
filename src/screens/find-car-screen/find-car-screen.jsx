        ...
        <View style={styles.container}>
            <View style={styles.container_location_picking}>
                ...
                <View style={styles.block_icons_from_to}>
                    <Image source={require("../../../assets/icons/pickup-location.png")} style={styles.icon_from_to} />
                    <Image source={require("../../../assets/icons/vertical-dot.png")} style={styles.icon_from_to} />
                    <Image source={require("../../../assets/icons/target-location.png")} style={styles.icon_from_to} />
                </View>
            ...
            <View style={styles.container_car_finding}>
                <View style={styles.img_background}>
                    <Image source={require("../../../assets/icons/ambulance-icon.png")} style={styles.car_icon} />
                </View>
